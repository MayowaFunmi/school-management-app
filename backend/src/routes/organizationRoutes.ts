...
import { addOrganization, adminOrganizations, listAllOrganizations, organizationByAdminId } from '../controllers/organizationController';
...
router.get('/get-admin-organizations', verifyLogin, checkAdminRole, adminOrganizations);
